...
import { List, RefreshCw, ChevronRight, Home, ShoppingCart, Eye } from "lucide-react";
import AllOrders from "@/components/desktop/admin/orders/AllOrders";
import ViewOrderTab from "@/components/desktop/admin/orders/ViewOrderTab";
...
export default function OrdersPage() {
    ...
    if (activeTab === "view" && selectedOrder) {
        tabs.push({
            ...
            label: "View Order",
            icon: Eye,
            description: `Viewing order ${selectedOrder._id?.slice(-8).toUpperCase()}`,
        });
    }
        ...
        <div className="min-h-screen bg-gray-50 dark:bg-gray-900">
            <div className="max-w-[1600px] mx-auto">
                ...
                <AnimatePresence mode="wait">
                    <motion.div
                        key={activeTab + (selectedOrder?._id || "")}
                    ...
                    >
                        ...
                        {activeTab === "view" && selectedOrder && (
                            <ViewOrderTab order={selectedOrder} onBack={handleBackToList} />
                        )}
                    </motion.div>
                </AnimatePresence>
